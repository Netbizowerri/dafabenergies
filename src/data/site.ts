...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "Growatt 14.3kWh Lithium Battery Storage",
    category: "Battery Storage",
    brand: "Growatt",
    image: "https://i.ibb.co/qMGsGsPH/Growatt-14-3k-Wh-Lithium-Battery-Storage.jpg",
    description:
      "High-capacity lithium storage for demanding backup and hybrid applications.",
    features: [
